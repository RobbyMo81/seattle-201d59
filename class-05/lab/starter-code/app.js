...
function sumArray(sumArr) { //eslint-disable-line;;
  let add2 = sum(testArray[0],testArray[1]);
  let add3 = sum(add2,testArray[2]);
  
  console.log('adding arrays ' + add2, add3);
}
//let returnArray = [9, '2,3,4 was passed in as an array of numbers, and ' + ]}
...
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. You're done! Submit the link to the repo following the instructions in
